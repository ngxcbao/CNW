		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="<?php echo e(route('issues.create')); ?>" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Thêm vấn đề mới</span></a>
					</div>
				</div>
			</div>
...
</html><?php /**PATH C:\xampp\htdocs\BTTH4\resources\views/issues/index.blade.php ENDPATH**/ ?>